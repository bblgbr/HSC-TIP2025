...
for param in trainer.StyleGAN.parameters():
    param.requires_grad = False

trainer.StyleGAN.eval()

print("Start!")

for n_epoch in tqdm(range(epoch_0, epochs)):

    iter_A = iter(loader_A) # stylegan2-generate-images
    iter_B = iter(loader_B) # ffhq real images

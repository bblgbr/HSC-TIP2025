...
def edit(opts):
    ...
    with torch.no_grad():
        ...
        for img in tqdm(img_list):
            ...
            # boundary = np.random.randn(1, 9216).astype(boundary.dtype)
...
def args():
    ...
    parser.add_argument('--input_path', type=str, default='/mnt/hdd1/zzf/FeatureStyleEncoder/data/celeba_hq_5k/', help='evaluation data file path')
    ...
    parser.add_argument('--boundary_dir', type=str, default='./boundaries_ours/', help='output data save path')

...
class MyDataSet(data.Dataset):
    def __init__(self, image_dir=None, label_dir=None, output_size=(256, 256), noise_in=None, training_set=True, video_data=False, train_split=0.9, is_car=False):
        ...
        if image_dir is not None:
            img_list = [glob.glob1(self.image_dir, ext) for ext in ['*jpg','*png', '*webp']]
